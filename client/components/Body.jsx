    ...
    render () {
      return (
        ...
        <div className="container-fluid features">
            ...
            <div className="row">
                <div className="col-md-4 text-center feature"><br /><p className="text-center"><i className="fa fa-user fa-5x"></i></p><p className="text-center">Have full control of your events</p></div>
                <div className="col-md-4 text-center feature"><br /><p className="text-center"><i className="fa fa-calendar-o fa-5x"></i></p><p className="text-center">Flexible booking for centers</p></div>
                <div className="col-md-4 text-center feature"><br /><p className="text-center"><i className="fa fa-search fa-5x"></i></p><p className="text-center">Look for centres within your community</p></div>
            </div>
        </div>
