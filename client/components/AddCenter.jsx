            ...
            <div className="container">
              <form>
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-9">
                    <input type="number" min="1" step="1" className="form-control" onChange={this.handleChange}
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-9">
                    <input type="number" min="1" step="any" className="form-control" onChange={this.handleChange}
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-9">
                    <input type="text" className="form-control" onChange={this.handleChange}
                      name="facilities" placeholder="Separate with commas" />
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-9">
                    <input ref="image" type="file" className="form-control" onChange={this.handleChange}
                ...
                <div className="form-group row">
                  <div className="offset-sm-3 col-sm-9">
                    <button type="submit" className="btn btn-sm btn-success" onClick={this.handleSubmit}>
                      <i className="fa fa-plus fa-lg" /> Add Center
                    </button>
                  </div>
                </div>
              </form>
