    ...
    return (
      ...
      <div className="card">
        <div className="card-block">
          ...
          <p className="text-center"><a href={`/centers/${this.props.centerDetails.id}`} className="btn btn-sm btn-primary"><i className="fa fa-info-circle fa-lg"></i> View Center</a>
        </p>
      </div>
    </div>
  </div>
