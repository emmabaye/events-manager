                ...
                <div className="col-md-4 event">
                  <div className="card">
                    <div className="card-block">
                      ...
                      <p className="text-center"><a href={`/events/${this.props.event.id}`} className="btn btn-sm btn-primary"><i className="fa fa-info-circle fa-lg"></i> View Event</a>
                      <a href="#" className="btn btn-sm btn-danger" ><i className="fa fa-times fa-lg"></i> Cancel</a></p>
                    </div>
                  </div>
                </div>
              </div>
